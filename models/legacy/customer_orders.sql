...
FROM jaffle_shop_orders as Orders
...
left join jaffle_shop_customers C on orders.USER_ID = C.ID )
...
from jaffle_shop_customers C 
left join jaffle_shop_orders as Orders
